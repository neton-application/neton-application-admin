...
export function updateFileConfigMaster(id: number) {
  return requestClient.put(`/infra/file-config/update-master/${id}`);
}
...
export function deleteFileConfig(id: number) {
  return requestClient.delete(`/infra/file-config/delete/${id}`);
}
...
export function testFileConfig(id: number) {
  return requestClient.get(`/infra/file-config/test/${id}`);
}
