...
export function agreeAfterSale(id: number) {
  return requestClient.put(`/trade/after-sale/agree/${id}`);
}
...
export function receiveAfterSale(id: number) {
  return requestClient.put(`/trade/after-sale/receive/${id}`);
}

/** 拒绝收货 */
export function refuseAfterSale(id: number) {
  return requestClient.put(`/trade/after-sale/refuse/${id}`);
}

/** 确认退款 */
export function refundAfterSale(id: number) {
  return requestClient.put(`/trade/after-sale/refund/${id}`);
}
