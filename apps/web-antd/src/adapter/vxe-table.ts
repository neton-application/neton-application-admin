...
setupVbenVxeTable({
  configVxeTable: (vxeUI) => {
    ...
    // Neton：from https://github.com/vbenjs/vue-vben-admin/blob/main/playground/src/adapter/vxe-table.ts#L97-L123
    ...
    // Neton：from https://github.com/vbenjs/vue-vben-admin/blob/main/playground/src/adapter/vxe-table.ts#L125-L255
